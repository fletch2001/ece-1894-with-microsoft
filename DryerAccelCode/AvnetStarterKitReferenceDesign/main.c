...
// 			snprintf(pjsonBuffer, JSON_BUFFER_SIZE, cstrButtonTelemetryJson, "buttonA", buttonAState);
...
// 			snprintf(pjsonBuffer, JSON_BUFFER_SIZE, cstrButtonTelemetryJson, "buttonB", buttonBState);
// 			Log_Debug("\n[Info] Sending telemetry %s\n", pjsonBuffer);
// 			AzureIoT_SendMessage(pjsonBuffer);
// 		//}
